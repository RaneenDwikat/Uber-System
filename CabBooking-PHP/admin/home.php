          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $inv = $conn->query("SELECT count(id) as total FROM cabs where delete_flag = 0 ")->fetch_assoc()['total'];
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $inv = $conn->query("SELECT count(id) as total FROM federal ")->fetch_assoc()['total'];
                    echo number_format($inv);
                  ?>
                  <?php ?>
                </span>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                <?php 
                    $services = $conn->query("SELECT count(id) as total FROM `federal` where Status = 'Cancelled' ")->fetch_assoc()['total'];
                    echo number_format($services);
                  ?>
                </span>
              </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                <?php 
                    $services = $conn->query("SELECT count(id) as total FROM `federal` where Status = 'Assigned'")->fetch_assoc()['total'];
                    echo number_format($services);
                  ?>
                </span>
              </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                <?php 
                    $services = $conn->query("SELECT count(id) as total FROM `federal` where Status = 'Arrived' ")->fetch_assoc()['total'];
                    echo number_format($services);
                  ?>
                </span>
              </div>
