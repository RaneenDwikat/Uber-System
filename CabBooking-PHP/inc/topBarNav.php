            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'booking_list'? "active" : '' ?>" href="./?p=booking_list">My Booking</a></li>
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'manage_account'? "active" : '' ?>" href="./?p=manage_account">Manage Account</a></li>
                        <li class="nav-item"><a class="nav-link <?= isset($page) && $page == 'Logout'? "active" : '' ?>" href="./classes/Login.php?f=logout_client">Log Out</a></li>
                        <?php endif; ?>
